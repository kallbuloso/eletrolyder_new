...
onMounted(() => {
  ...
  // console.log('SoDevice page mounted')
})
</script>

<template layout="AppShell,AuthenticatedLayout">
  <template v-if="props.count > 0">
    <v-card class="mx-auto" width="800" prepend-icon="mdi-account-lock" :title="pageTitle">
      <template #append>
